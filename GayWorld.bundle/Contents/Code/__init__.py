...
class GayWorld(Agent.Movies):
                ...
                for title in titleList:
                    ...
                    try:
                        ...
                        try:
                            ...
                            self.log('SEARCH:: Error getting Site URL Studio: %s', e)
                            continue
                    except:
    ...
    def update(self, metadata, media, lang, force=True):
        ...
        try:
            summary = ''
            htmlsummary = html.xpath('//strong[contains(.,"Description:")]//parent::p/text()')
        ...
        try:
            directors = []
            htmldirector = html.xpath('//strong[contains(.,"Director")]//following::text()')[0].replace(': ', '').split(',')
        ...
        try:
            htmlimages = html.xpath('//a[@class="fusion-lightbox"]/@href')[:2]  # only need first two images
