...
class GEVIScenes(Agent.Movies):
    ...
    def search(self, results, media, lang, manual):
        ...
        if process is True:
            try:
                siteTitle = html.xpath('//td[@class="gc"]/h1/text()')[0].strip()
        ...
        if process is True:
            utils.log(LOG_BIGLINE)
            try:
                siteStudio = html.xpath('//td[@class="gcnrb"]/a[contains(@href, "/company/")]/text()')[0].strip()
        ...
        if process is True:
            utils.log(LOG_BIGLINE)
            try:
                siteReleaseDate = html.xpath('//td[@class="gcnrbt"]/text()')[0]
