...
class HomoActive(Agent.Movies):
    ...
    def search(self, results, media, lang, manual):
        ...
        titleList = HTML.ElementFromURL(searchQuery, sleep=DELAY).xpath('//*[@class="item"]')
    ...
    def update(self, metadata, media, lang, force=True):
        ...
        # 2e.   Posters - Front Cover set to poster
        try:
        ...
        # 2f.   Background Art - Back Cover to background art - 2nd image in list is usually back of dvd
        try:
